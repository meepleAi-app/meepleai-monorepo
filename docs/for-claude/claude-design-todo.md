...
```
Controlla stato M6 Gruppo 1 sul branch redesign/v2 (git log + docs/for-developers/plans/2026-04-20-m6-gruppo1-migration.md) e riprendi dai task pending. Usa subagent-driven-development.
```
...
**Brief**: `docs/for-developers/specs/2026-04-20-claude-design-missing-pages-brief.md` sezione 2.1
...
**Brief completo**: `docs/for-developers/specs/2026-04-20-claude-design-group4-extended-brief.md`
...
````
[regole universali]
Leggi il brief `docs/for-developers/specs/2026-04-20-claude-design-group4-extended-brief.md` sezione "Discovery feed" e produci `admin-mockups/design_files/discovery.html` + `discovery.jsx` + variante dark + update 00-hub.html.
````
...
| Brief Gruppo 1+2+3 | `docs/for-developers/specs/2026-04-20-claude-design-missing-pages-brief.md` |
| Brief Gruppo 4 esteso | `docs/for-developers/specs/2026-04-20-claude-design-group4-extended-brief.md` |
| Plan M6 (in corso) | `docs/for-developers/plans/2026-04-20-m6-gruppo1-migration.md` |
| Plan pilot library | `docs/for-developers/plans/2026-04-20-redesign-v2-library-pilot-plan.md` |
| Plan M1-M5 core | `docs/for-developers/plans/2026-04-20-redesign-v2-full-app-migration-m1-m5.md` |
