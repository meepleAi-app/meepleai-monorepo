              ...
              <div className="flex items-start gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {t.isApproved ? (
                      <span className="inline-flex items-center gap-1 rounded-full bg-[hsl(var(--c-success)/0.15)] px-2 py-0.5 text-[10px] font-medium text-[hsl(var(--c-success-ink))]">
                        <Check className="h-3 w-3" /> Approved
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1 rounded-full bg-[hsl(var(--c-warning)/0.15)] px-2 py-0.5 text-[10px] font-medium text-[hsl(var(--c-warning-ink))]">
                        Pending
                      </span>
                    )}
                  </div>
              ...
              <div className="flex items-center gap-1 shrink-0 self-end sm:self-start">
                {!t.isApproved && (
                  <Button
                    ...
                    aria-label="Approve"
                  >
                    <Check className="h-4 w-4 text-[hsl(var(--c-success-ink))]" />
                  </Button>
                )}
                <Button
                  variant="ghost"
