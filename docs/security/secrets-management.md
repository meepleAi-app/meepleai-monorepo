...
> **Last Updated**: 2026-01-17 (restored 2026-05-06 from `03dc2872a^:docs/deployment/secrets-management.md`; relative paths re-rooted from `docs/deployment/` → `docs/security/`)
...
- **Health Check System**: `docs/deployment/health-checks.md` (pending restoration)
