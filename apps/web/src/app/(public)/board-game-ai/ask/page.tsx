...
export const metadata: Metadata = {
  ...
  description:
    'Ask questions about board game rules and get instant AI-powered answers with citations from official rulebooks.',
  keywords: ['board game', 'AI', 'rules', 'question answering', 'game assistant'],
  openGraph: {
    title: 'Ask Board Game AI - MeepleAI',
    description:
      'Get instant answers to your board game rule questions with AI-powered assistance.',
    type: 'website',
    locale: 'it_IT',
  },
  robots: {
