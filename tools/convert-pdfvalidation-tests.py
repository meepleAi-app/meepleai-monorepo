#!/usr/bin/env python3
"""
FluentAssertions Migration Script for PdfValidationServiceTests.cs
Converts xUnit Assert.* patterns to FluentAssertions syntax

Phase 13 Target: 55 assertions in PdfValidationServiceTests.cs
Distribution: Contains(22), False(14), True(11), Equal(8)
Expected automation: 100% (all basic patterns!)
"""
...
def main():
    file_path = "tests/Api.Tests/PdfValidationServiceTests.cs"
    ...
    if content != original_content:
        ...
        print(f"[INFO] Phase 13 complete - continuing momentum past 40%!")
        return 0
    else:
