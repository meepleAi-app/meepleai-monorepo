...
#pragma warning disable CA1707 // Identifiers should not contain underscores - migration name format
    public partial class Issue4212_ProcessingMetricsTable : Migration
#pragma warning restore CA1707
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Create pdf_processing_metrics table for historical metrics storage
            // Issue #4212: Duration metrics and ETA calculation
            ...
            // Index for fast historical queries (step-based filtering with time ordering)
            migrationBuilder.CreateIndex(
                name: "IX_pdf_processing_metrics_step_created_at",
                table: "pdf_processing_metrics",
                columns: new[] { "step", "created_at" },
                descending: new[] { false, true }); // DESC on created_at for recent-first
