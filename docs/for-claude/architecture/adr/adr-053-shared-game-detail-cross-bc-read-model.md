...
**Date**: 2026-04-29
**Deciders**: @badsworm
**Spec-panel ref**: Wave A.4 spec §11 (originally numbered "ADR 0014" in the V2 migration spec at `docs/for-developers/specs/2026-04-28-v2-migration-wave-a-4-shared-game-detail.md`)
...
- Wave A.4 spec — `docs/for-developers/specs/2026-04-28-v2-migration-wave-a-4-shared-game-detail.md`
