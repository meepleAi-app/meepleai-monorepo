...
namespace Api.Infrastructure.Migrations
{
    ...
    [Migration("20260220181510_AddAgentDefinitionKbCardIds")]
    partial class AddAgentDefinitionKbCardIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.VectorDocumentEntity", b =>
                {
                    ...
                    b.ToTable("vector_documents", null, t =>
                        {
                            t.HasCheckConstraint("CK_vector_documents_game_or_shared_game", "(game_id IS NOT NULL OR shared_game_id IS NOT NULL)");
                        });
                });
