...
import { Activity, BarChart3, ChevronDown, ChevronRight, Clock, Cpu, Database, DollarSign, Gauge, Globe, Route, Server, Workflow } from 'lucide-react';
...
export function DebugPanel() {
  const { messages, tokenBreakdown, confidence, latencyMs, pipelineSteps, agentConfig, latencyBreakdown, costBreakdown, sessionTotalCost, activeStrategy, strategyInfo, pipelineTimings, cacheInfo, sessionCacheHits, sessionCacheRequests, apiTraces } = usePlaygroundStore();
