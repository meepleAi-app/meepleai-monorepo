...
- `docs/for-developers/frontend/visual-regression.md`: documenta workflow update snapshot, threshold rationale, comparison Phase 1+2 impl-vs-mockup
...
- [ ] Doc `docs/for-developers/frontend/visual-regression.md` con workflow Phase 1+2
...
- Audit script `scripts/audit-tokens.ts`: confronta `apps/web/src/styles/design-tokens.css` con `admin-mockups/design_files/tokens.css`. Output diff in `docs/for-developers/frontend/token-audit-2026-04-26.md`. Fix discrepanze (probabili: `--c-success/warning/danger/info` semantic aliases mancanti)
...
**Deliverables**:
- `docs/for-developers/frontend/v2-migration-matrix.md`: tabella markdown con colonne:
...
- `docs/for-developers/frontend/v2-migration-matrix.md` referenziato da `CLAUDE.md` sezione Architecture
...
1. **Hook dependency graph** — `docs/for-developers/frontend/contracts/<route>-hooks.md`
   ```markdown
...
- `docs/for-developers/frontend/v2-migration-phase1-2-retro.md`:
