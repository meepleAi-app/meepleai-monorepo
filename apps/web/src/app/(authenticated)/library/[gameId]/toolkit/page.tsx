          ...
          {template && (
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">Scoring Categories</p>
                ...
                {template.rounds.length > 0 && (
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">Rounds</p>
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">Scoring Rules</p>
                  <p className="text-sm text-muted-foreground">{template.scoringRules}</p>
                </div>

                <div>
                  <p className="text-sm font-semibold text-foreground mb-1">Players</p>
