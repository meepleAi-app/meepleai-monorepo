...
export const AllHealthy: Story = {
  args: {
    services: [
      ...
      createMockService('grafana', 'Healthy', 50000),
    ],
    locale: 'it',
  },
};
...
export const MixedStates: Story = {
  args: {
    services: [
      ...
      createMockService('prometheus', 'Healthy', 10000),
      createMockService('grafana', 'Degraded', 2500000, 'Slow response time'),
    ],
    locale: 'it',
  },
};
...
export const AllUnhealthy: Story = {
  args: {
    services: [
      ...
      createMockService('grafana', 'Unhealthy', 0, 'Observability stack down'),
    ],
    locale: 'it',
  },
};
...
export const Grid3Columns: Story = {
  args: {
    services: [
      ...
      createMockService('prometheus', 'Healthy', 10000),
      createMockService('grafana', 'Unhealthy', 0, 'Service down'),
    ],
    layout: 'grid-3',
    locale: 'it',
  },
