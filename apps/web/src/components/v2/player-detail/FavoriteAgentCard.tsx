// TODO: implement per admin-mockups/design_files/sp4-player-detail.jsx
// Mapped from mockup component: FavoriteAgentCard
...
export function FavoriteAgentCard(_props: FavoriteAgentCardProps): ReactElement | null {
  return null;
}
