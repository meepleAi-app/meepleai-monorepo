...
export default function WizardError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error('Admin Wizard Error:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      >
        ...
        <h2 className="mb-2 font-quicksand text-xl font-bold text-[#2D2A26]">Errore nel wizard</h2>
        <p className="mb-6 font-nunito text-sm text-[#6B665C]">
          Si è verificato un errore nel processo di configurazione. Riprova o torna alla dashboard.
        </p>
