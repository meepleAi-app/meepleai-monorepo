...
// Mapped from mockup component: KbProcessingState
...
export interface KbProcessingStateProps {
  // TODO: extract props contract from mockup analysis
}

export function KbProcessingState(_props: KbProcessingStateProps): ReactElement | null {
  return null;
}
