...
See: `security-testing-strategy.md` (documentation pending)
...
- `code-scanning-remediation-summary.md` - Historical fixes (documentation pending)
- `codeql-csharp-status-2025-11-18.md` - Snapshot status (documentation pending)
...
- `cors-configuration.md` - CORS whitelist (ADR-011) (documentation pending)
