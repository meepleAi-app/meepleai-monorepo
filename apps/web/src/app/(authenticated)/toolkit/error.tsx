...
export default function ToolkitError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error('Toolkit Error:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      >
        ...
        <h2 className="mb-2 font-quicksand text-xl font-bold text-[#2D2A26]">Errore toolkit</h2>
