# Admin Dashboard Epic - GitHub Issues

**Epic Created**: 2026-02-12
**Epic Issue**: #4192
...
### Epic
- **#4192**: Admin Dashboard with Block System

### Frontend Issues
- **#4193**: [Frontend] Collection Overview Block - Stats Display
- **#4194**: [Frontend] Approval Queue Block - Shared Games Management
- **#4195**: [Frontend] User Management Block - User Cards & Detail Panel
- **#4196**: [Frontend] Detail Pages - Collection, Approvals, Users
- **#4197**: [Frontend] API Client Integration - Production Ready

### Backend Issues
- **#4198**: [Backend] Verify Admin Stats Endpoint - Schema Adaptation
- **#4199**: [Backend] Verify Approval Queue Endpoint - Add User Info
- **#4200**: [Backend] Verify User Management Endpoints - Add Active Status
- **#4201**: [Backend] Verify User Library Stats Endpoint
- **#4202**: [Backend] Verify User Badges Endpoint

### Testing Issues
- **#4203**: [Testing] Frontend Component Tests - Dashboard
- **#4204**: [Testing] E2E Workflow Tests - Admin Actions
- **#4205**: [Testing] API Integration Tests - Admin Endpoints
...
**Created**: 13 issues + 1 epic = 14 total
**Completed**: 0/13
**In Progress**: 0/13
**Estimated Total**: 46-58 hours

---

**All issues created and linked to epic!** ✅
