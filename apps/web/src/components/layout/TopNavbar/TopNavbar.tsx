...
function SectionDropdown({ section, isOpen, onToggle, onClose, isActive }: SectionDropdownProps) {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isItemActive ? 'bg-primary/10 text-primary' : 'text-foreground hover:bg-muted'
                )}
              >
                <Icon className="h-4 w-4 mt-0.5 shrink-0" />
                <div className="min-w-0">
                  <p className="text-sm font-semibold font-quicksand leading-none">{item.label}</p>
                  {item.description && (
