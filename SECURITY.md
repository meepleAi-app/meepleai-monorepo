...
**DO**:
- Report via GitHub Security Advisories: [Create Security Advisory](https://github.com/meepleAi-app/meepleai-monorepo/security/advisories/new)
...
### Process
**Automated reminder issues** are created quarterly via GitHub Actions (see `.github/workflows/security-review.yml`).

**Review template**: [docs/security/security-review-template.md](./docs/security/security-review-template.md)
...
### Deliverables
- **Quarterly Report**: `docs/security/YYYY-QN-security-review.md` (from template)
...
**See**: [docs/security/](./docs/security/) directory
...
Reports are available in [GitHub Security tab](https://github.com/meepleAi-app/meepleai-monorepo/security).
