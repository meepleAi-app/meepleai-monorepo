...
internal sealed class SaveRagConfigCommandValidator : AbstractValidator<SaveRagConfigCommand>
{
    ...
    public SaveRagConfigCommandValidator()
    {
        ...
        // #3847 — le regole seguenti selezionano campi ANNIDATI in Config, e il selettore viene
        // valutato prima di qualunque regola: con Config assente sollevavano
        // NullReferenceException invece di segnalare il campo mancante. Il NotNull qui sopra da'
        // gia' il messaggio giusto; questo blocco semplicemente non deve girare.
