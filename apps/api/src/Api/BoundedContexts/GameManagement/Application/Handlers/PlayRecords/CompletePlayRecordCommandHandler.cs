...
/// <summary>
/// Handles completing a play record.
/// Issue #3889: CQRS commands for play records.
/// </summary>
internal class CompletePlayRecordCommandHandler : ICommandHandler<CompletePlayRecordCommand>
{
    private readonly IPlayRecordRepository _recordRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly TimeProvider _timeProvider;

    public CompletePlayRecordCommandHandler(
    ...
    public async Task Handle(CompletePlayRecordCommand command, CancellationToken cancellationToken)
    {
        ...
        record.Complete(command.ManualDuration, _timeProvider);
