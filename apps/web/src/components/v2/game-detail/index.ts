 ...
 *
 * Centralised re-exports so `GameDetailViewV2` (Commit 3) and downstream
...
export { GameDetailTabsAnimated } from './GameDetailTabsAnimated';
export type { GameDetailTabConfig, GameDetailTabsAnimatedProps } from './GameDetailTabsAnimated';
