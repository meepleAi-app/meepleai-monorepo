...
namespace Api.Infrastructure.Migrations
{
    ...
    [Migration("20260827125533_SessionDeckToolboxOwnership")]
    partial class SessionDeckToolboxOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.BoundedContexts.Administration.Domain.Aggregates.ProviderCredentials.ProviderCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("PreviousCredentialId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProviderName", "RotatedAt")
            ...
            modelBuilder.Entity("Api.BoundedContexts.AgentMemory.Infrastructure.Entities.GameMemoryEntity", b =>
                {
                    ...
                    b.Property<string>("GlossaryEntriesJson")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Api.BoundedContexts.DocumentProcessing.Domain.Entities.PhotoBatchPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PhotoBatchUploadId", "PageNumber")
                        .IsUnique()
                        .HasDatabaseName("uq_photo_batch_pages_batch_page");

                    b.ToTable("photo_batch_pages", (string)null);
                });

            modelBuilder.Entity("Api.BoundedContexts.DocumentProcessing.Domain.Entities.PhotoBatchUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.BoundedContexts.KnowledgeBase.Domain.Entities.AgentDefinition", b =>
                {
                    ...
                    b.Property<int>("_invocationCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("invocation_count");

                    b.Property<bool>("_isSystemDefined")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<DateTime?>("_lastInvokedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("_typologySlug")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.HasIndex("_typologySlug")
                        .HasDatabaseName("ix_agent_definitions_typology_slug");
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.Administration.AlertChannelEntity", b =>
                {
                    ...
                    b.Property<Guid?>("LastDispatchedEventId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.Administration.HealthStatusAlertSentEntity", b =>
                {
                    ...
                    b.ToTable("health_status_alerts_sent", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.AuditOutboxEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.Authentication.AccessRequestEntity", b =>
                {
                    ...
                    b.Property<Guid?>("LastNotifiedEventId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_notified_event_id");
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.BusinessSimulations.AppBudgetEntity", b =>
                {
                    ...
                    b.Property<int>("AlertThresholdPct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(80)
                    ...
                    b.Property<int>("CriticalThresholdPct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(95)
                    ...
                    b.Property<string>("MonthlyLimitCurrency")
                        .IsRequired()
                        .HasMaxLength(3)
                    ...
                    b.ToTable("app_budgets", null, t =>
                        {
                            t.HasCheckConstraint("ck_app_budgets_alert_below_critical", "alert_threshold_pct < critical_threshold_pct");

                            t.HasCheckConstraint("ck_app_budgets_monthly_limit_positive", "monthly_limit_amount > 0");
                        });
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.GameNightEventEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RsvpClosedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("rsvp_closed_at");
                    ...
                    b.Property<Guid?>("VotingWinnerGameId")
                        .HasColumnType("uuid")
                        .HasColumnName("voting_winner_game_id");
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.GameNightInvitationEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RsvpConfirmationSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("rsvp_confirmation_sent_at");
                    ...
                    b.HasIndex("GameNightId", "Status")
                        .HasDatabaseName("IX_game_night_invitations_event_status");

                    b.HasIndex("GameNightId", "Email", "Status")
                        .HasDatabaseName("IX_game_night_invitations_event_email_status");

                    b.ToTable("game_night_invitations", (string)null);
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.GameNightPhotoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameNightId", "Sha256Hash")
                        .IsUnique()
                        .HasDatabaseName("UX_game_night_photos_gamenight_sha256");

                    b.ToTable("game_night_photos", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.GameNightVoteEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("CandidateGameId")
                        .HasColumnType("uuid")
                        .HasColumnName("candidate_game_id");
                    ...
                    b.HasIndex("EventId", "CandidateGameId")
                        .HasDatabaseName("IX_game_night_votes_event_candidate");

                    b.HasIndex("EventId", "VoterUserId", "CandidateGameId")
                        .IsUnique()
                        .HasDatabaseName("IX_game_night_votes_event_voter_candidate");

                    b.ToTable("game_night_votes", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.GamePhaseTemplateEntity", b =>
                {
                    ...
                    b.HasIndex("GameId", "PhaseOrder")
                        .IsUnique()
                        .HasDatabaseName("ix_game_phase_templates_game_id_order");

                    b.ToTable("game_phase_templates", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.LiveGameSessionEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSnapshotTimestamp")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("PhaseNamesJson")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("SnapshotTriggerConfigJson")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameManagement.PlayRecordVersionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlayRecordId", "CreatedAt")
                        .HasDatabaseName("IX_play_record_versions_record_createdat");

                    b.HasIndex("PlayRecordId", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("UX_play_record_versions_record_version");

                    b.ToTable("play_record_versions", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.GameToolkit.AiToolkitSuggestionCacheEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ai_toolkit_suggestion_cache", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SessionTracking.SessionDeckEntity", b =>
                {
                    ...
                    b.ToTable("SessionDecks", "session_tracking", t =>
                        {
                            t.HasCheckConstraint("CK_SessionDecks_Owner", "(\"SessionId\" IS NOT NULL AND \"ToolboxId\" IS NULL) OR (\"SessionId\" IS NULL AND \"ToolboxId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.BggTosHashEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("bgg_tos_hashes", (string)null);
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.CatalogSeedDraftEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ResultingSharedGameId")
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("catalog_seed_drafts", (string)null);
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.CatalogSyncRunEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LogTailJsonPath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("catalog_sync_runs", null, t =>
                        {
                            t.HasCheckConstraint("ck_catalog_sync_runs_provider_range", "provider BETWEEN 0 AND 2");

                            t.HasCheckConstraint("ck_catalog_sync_runs_status_range", "status BETWEEN 0 AND 4");
                        });
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.CertificationThresholdsConfigEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");

                    b.Property<int>("MaxPageTolerance")
                        .HasColumnType("integer")
                        .HasColumnName("max_page_tolerance");

                    b.Property<decimal>("MinBggMatchPct")
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("min_bgg_match_pct");

                    b.Property<decimal>("MinCoveragePct")
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("min_coverage_pct");

                    b.Property<decimal>("MinOverallScore")
                        .HasColumnType("numeric(5,2)")
                    ...
                    b.ToTable("certification_thresholds_config", null, t =>
                        {
                            t.HasCheckConstraint("ck_certification_thresholds_config_max_page_tolerance_non_negative", "max_page_tolerance >= 0");

                            t.HasCheckConstraint("ck_certification_thresholds_config_pct_ranges", "min_coverage_pct BETWEEN 0 AND 100 AND min_bgg_match_pct BETWEEN 0 AND 100 AND min_overall_score BETWEEN 0 AND 100");

                            t.HasCheckConstraint("ck_certification_thresholds_config_singleton", "id = 1");
                        });
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.GameCoverAssignmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("GeneratedR2Key")
                        .HasColumnType("text")
                        .HasColumnName("generated_r2_key");
                    ...
                    b.HasIndex("SharedGameId", "Context")
                        .IsUnique()
                        .HasDatabaseName("ux_game_cover_assignments_game_context");

                    b.ToTable("game_cover_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CertificationOverrideReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.Property<Guid?>("CertifiedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("certified_by_user_id");

                    b.Property<DateTime?>("CostCapOverrideAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("cost_cap_override_at");

                    b.Property<Guid?>("CostCapOverrideBy")
                        .HasColumnType("uuid")
                        .HasColumnName("cost_cap_override_by");

                    b.Property<string>("CostCapOverrideReason")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("cost_cap_override_reason");

                    b.Property<decimal>("CostCapUsd")
                    ...
                    b.Property<Guid?>("LastMetricsId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_metrics_id");
                    ...
                    b.Property<int?>("SuppressionRequestSource")
                        .HasColumnType("integer")
                        .HasColumnName("suppression_request_source");

                    b.Property<DateTime?>("SuppressionRequestedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("suppression_requested_at");
                    ...
                    b.HasIndex("CertificationStatus")
                        .HasDatabaseName("ix_mechanic_analyses_certification_status");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_mechanic_analyses_created_by");
                    ...
                    b.HasIndex("PdfDocumentId")
                        .HasDatabaseName("ix_mechanic_analyses_pdf_document_id");
                    ...
                    b.ToTable("mechanic_analyses", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_mechanic_analyses_cost_cap_positive", "cost_cap_usd > 0");

                            t.HasCheckConstraint("ck_mechanic_analyses_status_range", "status BETWEEN 0 AND 4");

                            t.HasCheckConstraint("ck_mechanic_analyses_suppression_completeness", "(is_suppressed = false AND suppressed_at IS NULL AND suppressed_by IS NULL AND suppression_reason IS NULL AND suppression_request_source IS NULL AND suppression_requested_at IS NULL) OR (is_suppressed = true AND suppressed_at IS NOT NULL AND suppressed_by IS NOT NULL AND suppression_reason IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisMetricsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("BggMatchPct")
                        .HasColumnType("numeric(5,2)")
                    ...
                    b.Property<string>("GoldenVersionHash")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<Guid>("MechanicAnalysisId")
                        .HasColumnType("uuid")
                        .HasColumnName("mechanic_analysis_id");

                    b.Property<decimal>("OverallScore")
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("overall_score");

                    b.Property<decimal>("PageAccuracyPct")
                        .HasColumnType("numeric(5,2)")
                    ...
                    b.HasIndex("MechanicAnalysisId")
                        .HasDatabaseName("ix_mechanic_analysis_metrics_analysis_id");

                    b.HasIndex("SharedGameId", "ComputedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_mechanic_analysis_metrics_shared_game_computed_at_desc");

                    b.ToTable("mechanic_analysis_metrics", null, t =>
                        {
                            t.HasCheckConstraint("ck_mechanic_analysis_metrics_certification_status_range", "certification_status BETWEEN 0 AND 2");

                            t.HasCheckConstraint("ck_mechanic_analysis_metrics_pct_ranges", "coverage_pct BETWEEN 0 AND 100 AND page_accuracy_pct BETWEEN 0 AND 100 AND bgg_match_pct BETWEEN 0 AND 100 AND overall_score BETWEEN 0 AND 100");
                        });
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisSectionRunEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AnalysisId")
                        .HasDatabaseName("ix_mechanic_section_runs_analysis_id");

                    b.HasIndex("Provider")
                        .HasDatabaseName("ix_mechanic_section_runs_provider");

                    b.HasIndex("AnalysisId", "RunOrder")
                        .IsUnique()
                        .HasDatabaseName("ux_mechanic_section_runs_analysis_run_order");

                    b.ToTable("mechanic_analysis_section_runs", null, t =>
                        {
                            t.HasCheckConstraint("ck_mechanic_section_runs_cost_non_negative", "estimated_cost_usd >= 0");

                            t.HasCheckConstraint("ck_mechanic_section_runs_error_when_failed", "status <> 1 OR error_message IS NOT NULL");
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicCitationEntity", b =>
                {
                    ...
                    b.HasIndex("ClaimId")
                        .HasDatabaseName("ix_mechanic_citations_claim_id");

                    b.HasIndex("ClaimId", "PdfPage")
                        .HasDatabaseName("ix_mechanic_citations_claim_page");

                    b.ToTable("mechanic_citations", null, t =>
                        {
                            t.HasCheckConstraint("ck_mechanic_citations_display_order_non_negative", "display_order >= 0");

                            t.HasCheckConstraint("ck_mechanic_citations_page_positive", "pdf_page > 0");

                            t.HasCheckConstraint("ck_mechanic_citations_quote_chars_cap", "char_length(quote) <= 400");

                            t.HasCheckConstraint("ck_mechanic_citations_quote_not_empty", "char_length(btrim(quote)) > 0");

                            t.HasCheckConstraint("ck_mechanic_citations_quote_word_cap", "array_length(regexp_split_to_array(btrim(quote), '\\s+'), 1) <= 25");
                        });
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicClaimEntity", b =>
                {
                    ...
                    b.HasIndex("AnalysisId")
                        .HasDatabaseName("ix_mechanic_claims_analysis_id");
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicGoldenBggTagEntity", b =>
                {
                    ...
                    b.HasIndex("SharedGameId")
                        .HasDatabaseName("ix_mechanic_golden_bgg_tags_shared_game_id");

                    b.HasIndex("SharedGameId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ux_mechanic_golden_bgg_tags_shared_game_name");

                    b.ToTable("mechanic_golden_bgg_tags", (string)null);
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicGoldenClaimEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("ExpectedPage")
                        .HasColumnType("integer")
                        .HasColumnName("expected_page");
                    ...
                    b.HasIndex("SharedGameId")
                        .HasDatabaseName("ix_mechanic_golden_claims_shared_game_id");

                    b.HasIndex("SharedGameId", "Section")
                        .HasDatabaseName("ix_mechanic_golden_claims_shared_game_section");

                    b.ToTable("mechanic_golden_claims", null, t =>
                        {
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicStatusAuditEntity", b =>
                {
                    ...
                    b.HasIndex("AnalysisId")
                        .HasDatabaseName("ix_mechanic_status_audit_analysis_id");

                    b.HasIndex("AnalysisId", "OccurredAt")
                        .HasDatabaseName("ix_mechanic_status_audit_analysis_time");

                    b.ToTable("mechanic_status_audit", null, t =>
                        {
                            t.HasCheckConstraint("ck_mechanic_status_audit_distinct_states", "from_status <> to_status");

                            t.HasCheckConstraint("ck_mechanic_status_audit_status_range", "from_status BETWEEN 0 AND 4 AND to_status BETWEEN 0 AND 4");
                        });
                });

            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicSuppressionAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AnalysisId")
                        .HasDatabaseName("ix_mechanic_suppression_audit_analysis_id");

                    b.HasIndex("AnalysisId", "OccurredAt")
                        .HasDatabaseName("ix_mechanic_suppression_audit_analysis_time");

                    b.ToTable("mechanic_suppression_audit", null, t =>
                        {
                            t.HasCheckConstraint("ck_mechanic_suppression_audit_request_source_range", "request_source IS NULL OR request_source BETWEEN 0 AND 3");
                        });
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.SharedGameEntity", b =>
                {
                    ...
                    b.Property<string>("BggCoverR2Key")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                    ...
                    b.Property<DateTime?>("ManualCoverAttestedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("manual_cover_attested_at");

                    b.Property<Guid?>("ManualCoverAttestedBy")
                        .HasColumnType("uuid")
                        .HasColumnName("manual_cover_attested_by");

                    b.Property<string>("ManualCoverAttribution")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("manual_cover_attribution");

                    b.Property<string>("ManualCoverLicense")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("manual_cover_license");

                    b.Property<string>("ManualCoverR2Key")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("manual_cover_r2_key");

                    b.Property<string>("ManualCoverSourceUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                    ...
                    b.Property<string>("PdfCoverR2Key")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                    ...
                    b.Property<DateTime?>("WikidataQidLastVerifiedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.SharedGameTranslationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SharedGameId", "Locale")
                        .IsUnique()
                        .HasDatabaseName("uq_active_translation_per_locale")
                        .HasFilter("NOT is_deleted");

                    b.ToTable("shared_game_translations", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.UserSessionEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTotpVerifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_totp_verified_at");
            ...
            modelBuilder.Entity("Api.BoundedContexts.DocumentProcessing.Domain.Entities.PhotoBatchPage", b =>
                {
                    b.HasOne("Api.BoundedContexts.DocumentProcessing.Domain.Entities.PhotoBatchUpload", null)
                        .WithMany("Pages")
                        .HasForeignKey("PhotoBatchUploadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("Api.BoundedContexts.SystemConfiguration.Domain.ValueObjects.TierLimits", "Limits", b1 =>
                        {
                            ...
                            b1.Property<int>("MaxGamebookTranslationsPerMonth")
                                .HasColumnType("integer")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisMetricsEntity", b =>
                {
                    b.HasOne("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisEntity", "MechanicAnalysis")
                        .WithMany()
                        .HasForeignKey("MechanicAnalysisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisSectionRunEntity", b =>
                {
                    b.HasOne("Api.Infrastructure.Entities.SharedGameCatalog.MechanicAnalysisEntity", "Analysis")
                        .WithMany("SectionRuns")
            ...
            modelBuilder.Entity("Api.Infrastructure.Entities.SharedGameCatalog.MechanicCitationEntity", b =>
                {
                    ...
                    b.HasOne("Api.Infrastructure.Entities.SharedGameCatalog.MechanicClaimEntity", "Claim")
                        .WithMany("Citations")
