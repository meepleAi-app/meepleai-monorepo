#!/usr/bin/env node
/**
 * DS-14 codemod — secondary clusters + remainder (Tier 4).
 * Targets ALL files with violations not already covered by DS-4..DS-13d.
 */
...
// All remaining files with violations
...
console.log(`\n[ds-14-codemod] Modified ${total}/${files.length} files.`);
