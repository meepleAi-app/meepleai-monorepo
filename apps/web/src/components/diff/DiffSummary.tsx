    ...
    <div className="p-4 bg-gray-100 border border-gray-300 rounded mb-4">
      ...
      <div className="grid grid-cols-4 gap-3 text-sm">
        ...
        >
          ...
          <div className="text-xs text-gray-600" data-testid="added-label">Aggiunte</div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-xs text-gray-600" data-testid="modified-label">Modificate</div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-xs text-gray-600" data-testid="deleted-label">Eliminate</div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-xs text-gray-600" data-testid="unchanged-label">Non modificate</div>
        </div>
      </div>
    </div>
  );
