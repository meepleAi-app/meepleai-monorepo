...
function ActionCard({
  ...
  return (
    <button
      ...
      className="group flex w-full items-center gap-3 rounded-xl border border-border bg-card px-4 py-4 text-left transition-colors hover:border-[hsl(var(--c-session))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
    >
    ...
    <div className="flex flex-col gap-5 px-4 py-6">
      <div className="text-center">
        <h2 className="font-quicksand text-xl font-bold">
          Tutto pronto! Cosa vuoi fare <span className="text-[hsl(var(--c-session))]">ora</span>?
        </h2>
