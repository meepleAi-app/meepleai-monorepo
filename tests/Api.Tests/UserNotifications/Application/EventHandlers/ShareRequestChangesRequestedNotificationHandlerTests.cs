...
/// <summary>
/// Integration tests for ShareRequestChangesRequestedNotificationHandler with in-memory database.
/// ISSUE-3005: Fixed DbContext mocking issues by using InMemoryDatabase.
/// </summary>
public sealed class ShareRequestChangesRequestedNotificationHandlerTests : IAsyncLifetime
{
    ...
    private ShareRequestChangesRequestedNotificationHandler _sut = null!;
    ...
    public ShareRequestChangesRequestedNotificationHandlerTests()
    {
        _options = new DbContextOptionsBuilder<MeepleAiDbContext>()
            .UseInMemoryDatabase($"ShareRequestChangesRequestedTest_{Guid.NewGuid()}")
            .Options;
