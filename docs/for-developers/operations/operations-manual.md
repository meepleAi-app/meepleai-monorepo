...
Existing runbooks in `docs/for-developers/operations/runbooks/`:
...
| File | Purpose |
|------|---------|
| `docs/for-developers/operations/ci-cd-pipeline.md` | 3-stage CI/CD pipeline reference (Spec R1+R2) |
