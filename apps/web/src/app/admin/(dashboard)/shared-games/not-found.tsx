    ...
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      >
        <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-[hsla(25,95%,38%,0.1)]">
          <Gamepad2 className="h-7 w-7 text-[hsl(25,95%,38%)]" />
        </div>
        <h2 className="mb-2 font-quicksand text-xl font-bold text-[#2D2A26]">Gioco non trovato</h2>
        <p className="mb-6 font-nunito text-sm text-[#6B665C]">
          Il gioco richiesto non esiste nel catalogo o è stato rimosso.
        </p>
        <Button
          asChild
