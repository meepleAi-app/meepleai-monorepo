...
describe('HeroSection', () => {
  ...
  describe('CTA Buttons', () => {
    ...
    it('renders secondary CTA button for scrolling', () => {
      ...
      const secondaryButton = screen.getByRole('button', { name: /scorri alla sezione caratteristiche/i });
    ...
    it('scroll button triggers smooth scroll to features section', () => {
      ...
      const scrollButton = screen.getByRole('button', { name: /scorri alla sezione caratteristiche/i });
