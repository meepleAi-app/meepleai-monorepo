...
public sealed class CreateAiModelConfigCommandHandler : ICommandHandler<CreateAiModelConfigCommand, AiModelConfigDto>
{
    private readonly IAiModelConfigurationRepository _repository;
    private readonly MeepleAiDbContext _db;

    public CreateAiModelConfigCommandHandler(
    ...
    public async Task<AiModelConfigDto> Handle(CreateAiModelConfigCommand request, CancellationToken cancellationToken)
    {
    ...
    private static AiModelConfigDto MapToDto(AiModelConfiguration model) => new()
    {
        Id = model.Id,
