...
internal sealed class TierStrategyAccessService : ITierStrategyAccessService
{
    ...
    private static readonly IReadOnlyDictionary<LlmUserTier, RagStrategy[]> s_defaultAccessMatrix =
        new Dictionary<LlmUserTier, RagStrategy[]>
        {
            ...
            { LlmUserTier.Premium, new[] { RagStrategy.Fast, RagStrategy.Balanced, RagStrategy.Precise, RagStrategy.Expert, RagStrategy.Consensus, RagStrategy.SentenceWindow, RagStrategy.Iterative, RagStrategy.MultiAgent, RagStrategy.StepBack, RagStrategy.QueryExpansion, RagStrategy.RagFusion } }
        };
