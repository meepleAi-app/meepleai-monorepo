...
- **API Key Auth**: `mpl_{env}_{base64}` format, PBKDF2 (210k iterations). Browser logins issue an encrypted, httpOnly, `SameSite=Strict` `meeple_apikey` cookie automatically; scripts can send `Authorization: ApiKey <value>`.
