...
/// <summary>
/// Tests for SuspendUserCommandHandler.
/// Issue #2886: Verify audit logging and user suspension.
/// </summary>
...
public class SuspendUserCommandHandlerTests
{
    ...
    [Fact]
    public async Task Handle_WithValidCommand_SuspendsUser()
    {
        // Arrange
        var userId = Guid.NewGuid();
        var requesterId = Guid.NewGuid();
        var reason = "Violation of community guidelines";
        var command = new SuspendUserCommand(userId.ToString(), requesterId, reason);
    ...
    [Fact]
    public async Task Handle_WithAlreadySuspendedUser_ThrowsDomainException()
    {
        // Arrange
        var userId = Guid.NewGuid();
        var requesterId = Guid.NewGuid();
    ...
    [Fact]
    public async Task Handle_WithoutReason_SuspendsUserSuccessfully()
    {
        // Arrange
        var userId = Guid.NewGuid();
        var requesterId = Guid.NewGuid();
        var command = new SuspendUserCommand(userId.ToString(), requesterId, null);
