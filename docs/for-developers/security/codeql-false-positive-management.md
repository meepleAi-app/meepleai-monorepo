...
3. **Comment Template:**
   ...
   See: docs/for-developers/security/codeql-false-positive-management.md
...
echo "See docs/for-developers/security/codeql-false-positive-management.md for dismissal guidelines"
```
