#!/usr/bin/env python3
"""
FluentAssertions Migration Script for PromptManagementServiceTests.cs
Converts xUnit Assert.* patterns to FluentAssertions syntax

Phase 7 Target: 72 assertions in PromptManagementServiceTests.cs
Distribution: Equal(37), Contains(12), True(11), Throws(5), False(3), Single(3)
"""
...
def main():
    file_path = "tests/Api.Tests/PromptManagementServiceTests.cs"
    ...
    if content != original_content:
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"\n[SUCCESS] Successfully migrated {total_conversions} assertions in PromptManagementServiceTests.cs")
        return 0
    else:
