...
/// <summary>
/// Validator for UpdateApiKeyManagementCommand.
/// Ensures key ID and user ID are provided.
/// </summary>
internal sealed class UpdateApiKeyManagementCommandValidator : AbstractValidator<UpdateApiKeyManagementCommand>
{
    public UpdateApiKeyManagementCommandValidator()
    {
        RuleFor(x => x.KeyId)
            .NotEmpty()
