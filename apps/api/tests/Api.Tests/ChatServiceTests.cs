...
public class ChatServiceTests
{
    ...
    private static AuditService CreateAuditService(MeepleAiDbContext dbContext)
    {
        return new AuditService(dbContext, NullLogger<AuditService>.Instance, TimeProvider.System);
    }
