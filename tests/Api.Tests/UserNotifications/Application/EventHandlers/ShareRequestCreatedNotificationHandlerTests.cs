...
/// <summary>
/// Integration tests for ShareRequestCreatedNotificationHandler with in-memory database.
/// ISSUE-3005: Fixed DbContext mocking issues by using InMemoryDatabase.
/// </summary>
public sealed class ShareRequestCreatedNotificationHandlerTests : IAsyncLifetime
{
    ...
    private ShareRequestCreatedNotificationHandler _sut = null!;
    ...
    public ShareRequestCreatedNotificationHandlerTests()
    {
        _options = new DbContextOptionsBuilder<MeepleAiDbContext>()
            .UseInMemoryDatabase($"ShareRequestCreatedTest_{Guid.NewGuid()}")
            .Options;
