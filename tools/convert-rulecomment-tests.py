#!/usr/bin/env python3
"""
FluentAssertions Migration Script for RuleCommentServiceTests.cs
Converts xUnit Assert.* patterns to FluentAssertions syntax

Phase 5 Target: 100 assertions in Services/RuleCommentServiceTests.cs
Distribution: Contains(35), Equal(30), Throws(11), Single(10), False(7), True(6)
"""
...
def main():
    ...
    if content != original_content:
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"\n[SUCCESS] Successfully migrated {total_conversions} assertions in RuleCommentServiceTests.cs")
        return 0
    else:
