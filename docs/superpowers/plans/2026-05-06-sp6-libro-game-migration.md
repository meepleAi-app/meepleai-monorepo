...
Add SP6 sections to matrix. Edit `docs/frontend/v2-migration-matrix.md`:
...
**Files:**
- Create: `docs/frontend/contracts/gamebook-upload-hooks.md`
...
- Mirror structure of `docs/frontend/contracts/sessions-id-summary-hooks.md` (Wave D.3 contract, 1199 lines)
- Required sections:
...
- SP6 mockups: `admin-mockups/design_files/sp6-libro-game-{index,photo-upload}.{html,jsx}`
- v2-migration-matrix.md: `docs/frontend/v2-migration-matrix.md`
- Pattern parents:
