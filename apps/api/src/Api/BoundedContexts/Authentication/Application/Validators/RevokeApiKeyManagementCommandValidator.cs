...
/// <summary>
/// Validator for RevokeApiKeyManagementCommand.
/// Ensures key ID and user ID are provided.
/// </summary>
internal sealed class RevokeApiKeyManagementCommandValidator : AbstractValidator<RevokeApiKeyManagementCommand>
{
    public RevokeApiKeyManagementCommandValidator()
    {
        RuleFor(x => x.KeyId)
            .NotEmpty()
