...
export default function AgentDefinitionError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error('Admin Agent Definition Error:', error);
  }, [error]);
    ...
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          >
            <Link href="/admin/agents/definitions">
