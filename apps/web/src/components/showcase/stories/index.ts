...
import { extraMeepleCardChatStory } from './extra-meeple-card-chat.story';
import { extraMeepleCardKbStory } from './extra-meeple-card-kb.story';
...
export const ALL_STORIES: ShowcaseStory<any>[] = [
  meepleCardStory,
  extraMeepleCardChatStory,
  extraMeepleCardKbStory,
  entityListViewStory,
  gameCarouselStory,
  actionGridStory,
  tagStripStory,
