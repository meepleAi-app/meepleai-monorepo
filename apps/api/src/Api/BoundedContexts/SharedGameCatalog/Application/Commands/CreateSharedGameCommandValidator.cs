...
/// <summary>
/// Validator for CreateSharedGameCommand.
/// </summary>
internal sealed class CreateSharedGameCommandValidator : AbstractValidator<CreateSharedGameCommand>
{
...
/// <summary>
/// Validator for GameRulesDto.
/// </summary>
internal sealed class GameRulesDtoValidator : AbstractValidator<GameRulesDto>
{
    public GameRulesDtoValidator()
    {
        RuleFor(x => x.Content)
            .NotEmpty().WithMessage("Rules content is required");

        RuleFor(x => x.Language)
            .NotEmpty().WithMessage("Language is required")
            .Length(2).WithMessage("Language must be a valid ISO 639-1 code (2 characters)");
    }
}
