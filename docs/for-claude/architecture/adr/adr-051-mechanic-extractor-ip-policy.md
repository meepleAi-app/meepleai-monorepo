...
**Sprint plan**: `docs/for-developers/plans/2026-04-25-mechanic-extractor-ai-validation-sprint-2.md`
...
Il calibration spike T23 (vedi `.docs-archive/research/ (Phase 1 archived)`) ha mostrato due problemi operativi causati da questa rigidità:
