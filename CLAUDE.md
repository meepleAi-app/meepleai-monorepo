...
| #3740 | 🔴 **I corpora di retrieval sono tre e diversi**: staging (heading-aware, mixed-language) ≠ snapshot del gate (Docnet, `lang` di fatto uniforme) ≠ dev locale. Una misura su uno **non predice** l'altro: generalizzare da staging al gate è costato 2 PR revertite. Dichiara sempre su quale corpus stai misurando. Numeri e storia: [audit prefisso e5 / cross-lingua](./docs/for-developers/audits/2026-08-17-e5-prefix-and-cross-lingual-retrieval-audit.md) |
