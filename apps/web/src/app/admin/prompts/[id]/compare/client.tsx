          ...
          <div className="p-8">
            ...
            {!loading && versions.length < 2 && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm">
                  You need at least two versions to use the comparison feature
                </p>
              </div>
            )}
                  ...
                  <div>
                    <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex justify-between text-sm text-gray-500">
                        <div>
                          <strong>Version {version1?.versionNumber}</strong> -{' '}
                          {new Date(version1?.createdAt || '').toLocaleString()}
                        </div>
                        <div>
                          <strong>Version {version2?.versionNumber}</strong> -{' '}
                      ...
                      <DiffEditor
                        ...
                        loading={
                          <div className="flex items-center justify-center h-[700px]">
                            <div className="text-center text-gray-500">Loading diff view...</div>
                          </div>
                        }
                      />
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg text-sm text-blue-800">
                      <strong>Legend:</strong> <span className="text-red-600">Red</span> indicates
                      removed content, <span className="text-emerald-600">Green</span> indicates
                      added content
                    </div>
                  </div>
                )}
