...
/**
 * A/B Test evaluation inner component — Blind comparison and scoring.
 * Issue #5502: A/B Testing frontend — Blind evaluation page.
 *
 * Extracted from page.tsx for webpack compatibility (Next.js pages only allow default + metadata exports).
 */
