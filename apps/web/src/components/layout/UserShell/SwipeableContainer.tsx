...
/**
 * SwipeableContainer — Swipeable panel container for user layout tabs.
 *
 * Features:
...
const TAB_ORDER: NavTab[] = ['home', 'library', 'play', 'chat'];
...
const SECTION_TITLES: Record<NavTab, string> = {
  home: 'Home',
  library: 'Libreria',
  play: 'Gioca',
  chat: 'Chat',
