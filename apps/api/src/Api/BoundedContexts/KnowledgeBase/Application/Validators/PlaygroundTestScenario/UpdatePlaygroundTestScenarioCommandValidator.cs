...
/// <summary>
/// Validator for UpdatePlaygroundTestScenarioCommand.
/// Issue #4396: PlaygroundTestScenario Entity + CRUD
/// </summary>
internal sealed class UpdatePlaygroundTestScenarioCommandValidator
    : AbstractValidator<UpdatePlaygroundTestScenarioCommand>
{
    private static readonly string[] s_allowedRoles = { "user", "assistant", "system" };

    public UpdatePlaygroundTestScenarioCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEqual(Guid.Empty).WithMessage("Scenario ID is required");
