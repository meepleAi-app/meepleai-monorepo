...
import { Plus, MessageSquare, Dices, ChevronDown, ChevronRight } from "lucide-react"
...
export function ChatSidebar({
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[280px] bg-card border-r border-border h-[calc(100vh-52px)]">
      {/* New Chat Button */}
      <div className="p-4">
        <Button
          onClick={onNewChat}
