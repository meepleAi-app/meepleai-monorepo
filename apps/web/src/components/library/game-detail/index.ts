/**
 * Game Detail Components Index (Issue #3513)
 *
 * Components for the library game detail page.
 */
...
export { GameDetailAgentTab, type GameDetailAgentTabProps } from './GameDetailAgentTab';
export { GameDetailKbTab, type GameDetailKbTabProps } from './GameDetailKbTab';
export { GameDetailSessionsTab, type GameDetailSessionsTabProps } from './GameDetailSessionsTab';
