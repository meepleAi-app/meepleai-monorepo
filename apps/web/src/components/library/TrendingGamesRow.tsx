      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none" role="list">
        {items.map((game, i) => (
          <Link
            ...
            href={`/games/${game.id}`}
            role="listitem"
            className="flex w-[110px] flex-shrink-0 flex-col overflow-hidden rounded-xl border-l-[3px] border-l-primary bg-card shadow-warm-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-warm-md"
          >
